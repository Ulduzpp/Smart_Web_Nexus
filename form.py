...
class InputForm(FlaskForm):
    ...
    fasting_blood_sugar = SelectField('Fasting Blood Sugar', choices=[('True', 'True'), ('False', 'False')], validators=[DataRequired()])
    ...
    excercise_angina = SelectField('Exercise Angina', choices=[('No', 'No'), ('Yes', 'Yes')], validators=[DataRequired()])
